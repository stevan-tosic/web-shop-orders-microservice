...
class TOrdersOriginal
{
     ...
     * @var int|null
     *
     * @ORM\Column(name="billing_status_id", type="integer", nullable=true)
     */
     ...
     * @var int|null
     *
     * @ORM\Column(name="api_account_id", type="integer", nullable=true)
     */
